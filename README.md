...
**Chater** is a Chat app using an [open source Parse](http://parseplatform.org/) backend.
...
<img src='chater-walkthrough.gif?raw=True' title='Video Walkthrough' width='' alt='Video Walkthrough' />
